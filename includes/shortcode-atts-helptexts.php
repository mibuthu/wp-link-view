...
$lv_shortcode_atts_helptexts = array(
	'view_type'      => array(
		'section'     => 'general',
		'description' => 'This attribute specifies how the links are displayed. The standard is to show the links in a list.<br />
	...
	'cat_filter'     => array(
		'section'       => 'general',
		'value_options' => 'category slugs',
		'description'   => 'This attribute specifies the link categories of which links are displayed. The default is an empty string to show all links.<br />
			...
			To show multiple categories you can use OR connection with the delimiter "<strong>|</strong>" or "<strong>,</strong>".<br />
			Examples:<br />
	...
	'exclude_cat'    => array(
		...
		'description'   => 'This attribute specifies which categories should be excluded. This attribute is only considered if the attribute "cat_filter" is not set.<br />
	...
	'show_cat_name'  => array(
		...
		'description'   => 'This attribute specifies if the category name is shown as a headline.',
	),

	'show_num_links' => array(
		'section'       => 'general',
		'value_options' => array( '0 &hellip; false', '1 &hellip; true' ),
		'description'   => 'This attribute specifies if the number of links shall be displayed in brackets next to the category name.<br />
			The cat name must be displayed (<code>show_cat_name=true</code>) to show the number of events.',
	),

	'link_orderby'   => array(
		'section'     => 'general',
		'description' => 'This attribute specifies the value to sort the links on for the links in each category.<br />
			...
			If you required a more detailed description for the available options visit <a href="https://codex.wordpress.org/Function_Reference/get_bookmarks#Parameters" target="_blank" rel="noopener">the wordpress codex</a>.<br />
			You can also specify the order direction with the attribute "link_order".',
	),

	'link_order'     => array(
		'section'     => 'general',
		'description' => 'This attribute sets the order direction for the "link_orderby" attribute.<br />
	...
	'num_links'      => array(
		...
		'description'   => 'This attribute sets the number of displayed links for each category.<br />
	...
	'show_img'       => array(
		'section'       => 'general',
		'value_options' => array( '0 &hellip; false', '1 &hellip; true' ),
		'description'   => 'This attribute specifies if the image is displayed instead of the name. This attribute is only considered for links where an image was set.',
	),

	'link_items'     => array(
		'section'       => 'general',
		'value_options' => array( 'name', 'address', 'description', 'image', 'rss', 'notes', 'rating' ),
		'description'   => 'This is a more complex but very powerful attribute.
	...
	'link_item_img'  => array(
		'section'     => 'general',
		'description' => 'With this attribute the display option for link images can be set, if no link image for a specific link is available.<br />
	...
	'link_target'    => array(
		'section'     => 'general',
		'description' => 'Set one of the given values to override the standard value which was set for the link.<br />
			Set the attribute to "std" if you don´t want to override the standard.',
	),

	'link_rel'       => array(
		'section'     => 'general',
		'description' => 'With this attribute you can set the "rel" attribute for the HTML-links (see <a href="https://www.w3schools.com/tags/att_a_rel.asp" target="_blank" rel="noopener">this link</a> for details).',
	),

	'class_suffix'   => array(
		'section'       => 'general',
		'value_options' => 'string',
		'description'   => 'This attribute sets the class suffix to allow different css settings for different link lists or sliders on the same site.<br />
			The standard is an empty string which specifies that no specific suffix will be used.',
	),

	'list_symbol'    => array(
		'section'     => 'list',
		'description' => 'This attribute sets the style type of the list symbol.<br />
	...
	'vertical_align' => array(
		'section'     => 'general',
		'description' => 'This attribute specifies the vertical alignment of the links. Changing this attribute normally only make sense if the link-images are displayed.<br />
	...
	'cat_columns'    => array(
		...
		'description'   => 'This attribute specifies if and how the categories shall be displayed in multiple columns in list view.<br />
	...
	'link_columns'   => array(
		'section'       => 'list',
		'value_options' => array( 'Number', 'static', 'css', 'masonry' ),
		'description'   => 'This attribute specifies if and how the links shall be displayed in multiple columns in list view.<br />
			There are 3 different types of multiple column layouts available. Find more information regarding the types and options in the chapter <a href="#multicol">Multi-column layout types and options</a>.',
	),
	...
	'slider_width'   => array(
		'section'       => 'slider',
		'value_options' => 'Number',
		'description'   => 'This attribute sets the fixed width of the slider. If the attribute is set to 0 the width will be calculated automatically due to the given image sizes.<br />
	...
	'slider_height'  => array(
		'section'       => 'slider',
		'value_options' => 'Number',
		'description'   => 'This attribute sets the fixed height of the slider. If the attribute is set to 0 the height will be calculated automatically due to the given image sizes.<br />
			This attribute is only considered if the view type "slider" is selected.',
	),
	...
	'slider_pause'   => array(
		'section'       => 'slider',
		'value_options' => 'Number',
		'description'   => 'This attribute sets the duration between the the slides in milliseconds. This is the time where you can see the link standing still before the next slide starts.<br />
			This attribute is only considered if the view type "slider" is selected.',
	),
	...
	'slider_speed'   => array(
		'section'       => 'slider',
		'value_options' => 'Number',
		'description'   => 'This attribute sets the animation speed of the slider in milliseconds. This is the time used to slide from one link to the next one.<br />
			This attribute is only considered if the view type "slider" is selected.',
	),
);
